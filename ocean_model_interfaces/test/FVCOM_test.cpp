...
FVCOM fvcomMultiple("./ocean_model_interfaces/test_data/axial_data_test", 1000, 1000, 10, 3, 10);
FVCOMStructure structure("./ocean_model_interfaces/test_data/axial_data_test", 1000, 1000, 10, 3);
